...
BOT_TOKEN = environ.get('BOT_TOKEN', '8190157134:AAFMorq12oAJX-1bdMTiBU4fs2r5iUwTyDQ')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002335493412'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+vz-07HOZgb1mNjA1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002466099174').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://morekoushal:morekoushal@mck.x9r8o.mongodb.net/?retryWrites=true&w=majority&appName=MCK")
DATABASE_NAME = environ.get('DATABASE_NAME', "MCK")
