...
API_HASH = environ.get(
    'API_HASH',
    'a4c3ce9493061323cbb5741370aa11f1'
)

BOT_TOKEN = environ.get(
    'BOT_TOKEN',
    '8665061977:AAG-DIBxcN8q7fdX0DwMnEsQfe862rSv1n4'
)

# ================= ADMINS & USERS =================
ADMINS = [
    int(admin) if id_pattern.search(admin) else admin
    for admin in environ.get('ADMINS', '1489423238').split()
]

USERNAME = environ.get(
    'USERNAME',
    "https://t.me/Morekoushal1444"
)
...
MOVIE_GROUP_LINK = environ.get(
    'MOVIE_GROUP_LINK',
    'https://t.me/jfjwknxanj'
)

CHANNELS = [
    int(ch) if id_pattern.search(ch) else ch
    for ch in environ.get('CHANNELS', '-1003756045123').split()
]

# ================= DATABASE =================
DATABASE_URI = environ.get(
    'DATABASE_URI',
    "mongodb+srv://Koushal:Koushal@koushal.zjd00.mongodb.net/?appName=Koushal"
)
...
QUALITIES = ["HdRip","web-dl","bluray","hdr","fhd","240p","360p","480p","720p","1080p","2K","4K","8K"]
